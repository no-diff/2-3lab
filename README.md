...
2. Назвати основні можливості, які надає система контролю версій Git та платформа
GitHub.
3. Які ще способи створення інтерактивних додатків в Python Ви знаєте? Які існують
аналоги в інших мовах, що застосовуються для аналізу даних (R, Matlab).
